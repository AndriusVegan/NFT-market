  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          <div className="rounded-xl bg-gradient-to-br from-yellow-400 to-purple-600 p-2">
            <img
              ...
              src="http://links.papereact.com/8sg"
            />
          </div>
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        {/* content */}
        <div className="spae-y-6 mt-10 flex flex-1 flex-col items-center lg:justify-center lg:space-y-0">
          <img
            className="w-80 object-cover pb-10 lg:h-40"
            src="https://links.papereact.com/bdy"
          />
          <h1 className="text-3xl font-bold lg:text-5xl">
            {' '}
            Vegan ape coding club
          </h1>
          <p className="text--xl pt-2 text-green-500"> Claim your NFT</p>
